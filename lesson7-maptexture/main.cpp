...
// g++ -Wall -pedantic -o texmap.exe main.cpp gl_utils.cpp maths_funcs.cpp -I ../common/include ../common/win32/libglew32.dll.a ../common/win32/glfw3dll.a -lOpenGL32 -L ./ -lglew32 -lglfw3 -lm
